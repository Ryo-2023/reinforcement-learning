...
state = load_data("E:/sotsuron/venv_sotsuron/src/data/hybrid/data_state.pkl")
belief = load_data("E:/sotsuron/venv_sotsuron/src/data/hybrid/data_belief.pkl")
action = load_data("E:/sotsuron/venv_sotsuron/src/data/hybrid/data_action.pkl")
...
ani.save("E:/sotsuron/venv_sotsuron/src/data/hybrid/plot_belief_hybrid.gif", writer=writer)
